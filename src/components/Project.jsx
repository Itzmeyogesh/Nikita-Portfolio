...
const Projects = () => {
  return (
    <section
      id="projects"
      className="h-screen flex flex-col justify-between items-center px-6 py-10 bg-[#16213e] text-white"
    >
      {/* Top Content */}
      ...
      {/* Bottom Scroll Arrow */}
      <a href="#contact" className="mt-10 mb-4 animate-bounce text-2xl">
        ↓
      </a>
    </section>
  );
