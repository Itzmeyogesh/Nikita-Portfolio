...
const Home = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#0f2027] via-[#203a43] to-[#2c5364] text-white px-4 text-center"
    >
      {/* Profile Image */}
      <motion.img
        src={profilePic}
      ...
      {/* Heading and Role */}
      <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-2">Hi, I'm Nikita Bhagwat</h1>
      ...
      {/* Scroll Arrow */}
      <a href="#about" className="mt-12 animate-bounce text-2xl">
        ↓
      </a>
    </section>
  );
